    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 to-accent/5 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Gestión Empresarial Premium para Latinoamérica</p>
        </div>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Accede a tu cuenta H&I System</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-8 text-center text-xs text-muted-foreground">
          ...
          <p className="mt-2">Gestión empresarial para el futuro de Latinoamérica</p>
        </div>
      </div>
    </div>
  );
